...
async function addRelationProperty(
  dataSourceId: string,
  propertyName: string,
  ...
  await notionPatch(`/data_sources/${dataSourceId}`, {
    properties: {
      [propertyName]: { relation: { data_source_id: targetDataSourceId, single_property: {} } },
    },
  });
}
...
const CONTACTS = [
  ...
  {
    name: "Emily Wright",
    email: "ewright@summitlogistics.com",
  ...
  {
    name: "James Liu",
    email: "james.liu@quantumdata.ai",
    phone: "+1-408-555-0106",
    company: "QuantumData AI",
    role: "VP of Sales",
  },
  {
    name: "Rachel Green",
    email: "rgreen@mediapulse.co",
    phone: "+1-323-555-0107",
    company: "MediaPulse",
    role: "Marketing Director",
  },
  {
    name: "Carlos Reyes",
    email: "carlos@fasttrack.dev",
    phone: "+1-305-555-0108",
    company: "FastTrack Dev",
    role: "Founder",
  },
  {
    name: "Lisa Patel",
    email: "lisa.patel@clearview.com",
  ...
  {
    name: "Mike O'Brien",
    email: "mobrien@greenvolt.com",
    phone: "+1-720-555-0114",
    company: "GreenVolt Energy",
    role: "Procurement Lead",
  },
  {
    name: "Sophie Martin",
    email: "smartin@datapeak.co",
...
const DEALS = [
  {
    ...
    notes: "Multi-year deal, needs security review",
    contactIdx: 0,
  },
  {
    name: "TechFlow Annual Contract",
    company: "TechFlow Inc",
    value: 85000,
    stage: "Proposal",
    owner: "You",
  ...
  {
    name: "Bright Horizon Onboarding",
    company: "Bright Horizon",
    value: 45000,
    stage: "Qualified",
    owner: "You",
    closeDate: "2026-04-01",
    notes: "Need to demo workflow automation",
    contactIdx: 2,
  },
  {
    name: "NovaPay Integration",
    company: "NovaPay",
    value: 200000,
    stage: "Negotiation",
    owner: "You",
    closeDate: "2026-02-20",
    notes: "Legal reviewing MSA, close is imminent",
    contactIdx: 3,
  },
  {
    name: "Summit Logistics Expansion",
    company: "Summit Logistics",
    value: 350000,
    stage: "Proposal",
    owner: "You",
    closeDate: "2026-05-01",
    notes: "Expanding from 50 to 500 seats",
    contactIdx: 4,
  },
  {
    name: "QuantumData POC",
    company: "QuantumData AI",
    value: 15000,
    stage: "Lead",
    owner: "You",
    closeDate: "2026-06-01",
    notes: "Inbound from website, exploring options",
    contactIdx: 5,
  },
  {
    name: "MediaPulse Content Suite",
    company: "MediaPulse",
    value: 60000,
    stage: "Closed Won",
    owner: "You",
  ...
  {
    name: "ClearView Analytics Renewal",
    company: "ClearView Analytics",
    value: 95000,
    stage: "Qualified",
    owner: "You",
    closeDate: "2026-03-30",
    notes: "Renewal conversation started, upsell opportunity",
    contactIdx: 8,
  },
  {
    name: "SteelBridge Pilot",
    company: "SteelBridge",
    value: 30000,
    stage: "Lead",
    owner: "You",
    closeDate: "2026-07-01",
    notes: "Referred by Tom Wilson, early stage",
    contactIdx: 9,
  },
];
...
const ACTIVITIES = [
  {
    summary: "Intro call with Sarah — discussed platform needs",
    type: "Call",
    date: daysAgo(25),
    contactIdx: 0,
    dealIdx: 0,
  ...
  {
    summary: "Sent proposal to Acme Corp",
    type: "Email",
    date: daysAgo(18),
    contactIdx: 0,
    dealIdx: 0,
  ...
  {
    summary: "Security review meeting with Acme",
    type: "Meeting",
    date: daysAgo(7),
    contactIdx: 0,
    dealIdx: 0,
  ...
  {
    summary: "John Park demo session",
    type: "Meeting",
    date: daysAgo(20),
    contactIdx: 1,
    dealIdx: 1,
  ...
  {
    summary: "Sent TechFlow pricing breakdown",
    type: "Email",
    date: daysAgo(12),
    contactIdx: 1,
    dealIdx: 1,
    followUp: daysFromNow(5),
  },
  {
    summary: "Discovery call with Maria",
    type: "Call",
    date: daysAgo(15),
    contactIdx: 2,
    dealIdx: 2,
  ...
  {
    summary: "Bright Horizon — scheduled demo for next week",
    type: "Note",
    date: daysAgo(5),
    contactIdx: 2,
    dealIdx: 2,
  ...
  {
    summary: "NovaPay legal review call",
    type: "Call",
    date: daysAgo(3),
    contactIdx: 3,
    dealIdx: 3,
  ...
  {
    summary: "MSA redline sent to NovaPay",
    type: "Email",
    date: daysAgo(2),
    contactIdx: 3,
    dealIdx: 3,
  ...
  {
    summary: "Emily Wright intro — expansion discussion",
    type: "Call",
    date: daysAgo(22),
    contactIdx: 4,
    dealIdx: 4,
  ...
  {
    summary: "Summit Logistics ROI analysis sent",
    type: "Email",
    date: daysAgo(10),
    contactIdx: 4,
    dealIdx: 4,
  ...
  {
    summary: "Summit exec presentation",
    type: "Meeting",
    date: daysAgo(4),
    contactIdx: 4,
    dealIdx: 4,
    followUp: daysFromNow(10),
  },
  {
    summary: "Inbound lead from QuantumData website",
    type: "Note",
    date: daysAgo(8),
    contactIdx: 5,
    dealIdx: 5,
  ...
  {
    summary: "MediaPulse contract signing",
    type: "Meeting",
    date: daysAgo(21),
    contactIdx: 6,
    dealIdx: 6,
  ...
  {
    summary: "MediaPulse onboarding kickoff",
    type: "Meeting",
    date: daysAgo(14),
    contactIdx: 6,
    dealIdx: 6,
  ...
  {
    summary: "FastTrack final pricing discussion",
    type: "Call",
    date: daysAgo(28),
    contactIdx: 7,
    dealIdx: 7,
  ...
  {
    summary: "FastTrack — lost deal retrospective note",
    type: "Note",
    date: daysAgo(26),
    contactIdx: 7,
    dealIdx: 7,
  ...
  {
    summary: "ClearView renewal intro with Lisa",
    type: "Call",
    date: daysAgo(9),
    contactIdx: 8,
    dealIdx: 8,
    followUp: daysFromNow(4),
  },
  {
    summary: "ClearView usage report sent",
    type: "Email",
    date: daysAgo(6),
    contactIdx: 8,
    dealIdx: 8,
  ...
  {
    summary: "Tom Wilson referral follow-up",
    type: "Call",
    date: daysAgo(2),
    contactIdx: 9,
    dealIdx: 9,
    followUp: daysFromNow(8),
  },
];
...
async function main() {
  ...
  const contactsDb = await createDatabase("Contacts", {
    ...
    "Consent Status": {
      select: {
        options: ["none", "implied", "express"].map((s) => ({ name: s })),
      },
    },
    "Opt Out": { checkbox: {} },
    Source: { rich_text: {} },
  ...
  const dealsDb = await createDatabase("Deals", {
    ...
    Stage: {
      select: {
        options: ["Lead", "Qualified", "Proposal", "Negotiation", "Closed Won", "Closed Lost"].map(
          (s) => ({ name: s }),
        ),
      },
    },
  ...
  const activitiesDb = await createDatabase("Activities", {
    ...
    Type: {
      select: {
        options: ["Call", "Email", "Meeting", "Note", "LinkedIn", "X"].map((s) => ({ name: s })),
      },
    },
    Date: { date: {} },
    "Follow-up Date": { date: {} },
  ...
  for (const a of ACTIVITIES) {
    ...
    await notionPost("/pages", {
      parent: { type: "data_source_id", data_source_id: activitiesDb.data_source_id },
      properties,
    });
  ...
  console.log(
    JSON.stringify({ deals: dealsDb, contacts: contactsDb, activities: activitiesDb }, null, 2),
  );
